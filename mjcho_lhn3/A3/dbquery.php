...
//catch if either statement was unable to be prepared
    ...
    <body>
        ...
        <form action="dbquery.php" method="POST">
            ...
            <select name="order_num" id="order_num">
                <option value=""></option>
                <?php
                //add dropdown option for each order number
            ...
            <br>
            <?php
            //add entry boxes for order date param
        ...
        if (!empty($_POST['order_num'])) {
            ...
            if (!empty($_POST['start_date']) && !empty($_POST['end_date'])) {
                ...
                //do not query if end date is before start date
                if(strtotime($_POST['end_date']) < strtotime($_POST['start_date']))
                {
                    echo "Start date should come before end date";
                }
                else{
        ...
        <table>
            <tr>
                <?php
                //add a cell in the row for each column name
                if(!empty($result)){
